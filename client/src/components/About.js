const About = () => (
  <div className="about-page">
    ...
    <p>
      ...
      think computationally. Use the filters in the sidebar to search for tools
      by the coding language used, the age group that tool tends to target, the
      hardware platform the tool can be used with, as well as whether or not the
      tool is still available for your own use. You can also search by tool
      categories, which we explain in the table below. If there is a tool
      missing that you think should be included in the catalog, click the
      “Suggest a Tool” button and let us know about it!
    </p>
    <h3>What this site is NOT</h3>
    <p>
      This catalog is NOT a list of curricula or resources to teach coding (that
      might be a future project). Rather, the focus is on the unique coding
      tools themselves.
    </p>
    <h2>Coding Tools Classification</h2>
    <p>
      As we put together this list of tools, we noticed that there were specific
      categories and sub-categories of coding tools for kids. This observation
    ...
    <table>
      ...
      <tr>
        ...
        <td>
          General programming environment wherein what is programmed can only be
      ...
      <tr>
        ...
        <td>
          Tool that helps students to create games or apps that can be deployed
      ...
      <tr>
        ...
        <td class="bottom">
          ...
          mechanic of interacting with and/or completing the game successfully.
        </td>
